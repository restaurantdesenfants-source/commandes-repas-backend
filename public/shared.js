...
// Vacances scolaires Wallonie 2026-2027 (dates inclusives, format ISO AAAA-MM-JJ).
// Aucun repas n'est servi ces jours-là : ils sont automatiquement indisponibles
// à la commande (côté école) et exclus des propositions d'encodage (côté cuisine).
...
// Renvoie l'objet vacances (avec son label) si la date tombe dedans, sinon null.
